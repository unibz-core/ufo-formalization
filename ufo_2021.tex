...
% Ax |= "th_everythingIsAThing_t1"; conjecture comment for convenience

% fof(th_everythingIsAThing_t1, conjecture, (
%   ![X]: (type(X) | individual(X))
% )).

% Ax |= "th_thingPartition_t2"; conjecture comment for convenience
...
% Ax |= "th_cyclicSpecializations_t3"; conjecture comment for convenience

% fof(th_cyclicSpecializations_t3, conjecture, (
%   ![X,Y]: (specializes(X,Y) => (specializes(X,X) & specializes(Y,Y)))
% )).

% Ax |= "th_transitiveSpecializations_t4"; conjecture comment for convenience
