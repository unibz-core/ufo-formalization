...
% %%%%%Taxonomy of Types accoording to their instances
...
% %%%%%Taxonomy accordint to metaproperty (sortality etc).
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %
% %Definition of instance of (iof), types, and individuals
% %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %Note: we need to drop that individuals are not wordls, as now worlds are abstract.
