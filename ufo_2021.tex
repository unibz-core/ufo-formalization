...
% TODO: check whether it is necessary to introduce fusion and existence of sums, and how to do it
...
% TODO: review why we need to constrain functions to hold between endurants and types only (not even "endurant types")
...
%   endurant(e12_1) & endurant(e12_2) & objectKind(k12_1) & objectKind(k12_2) & world(w12) & ~(k12_1=k12_2) & iof(e12_1,k12_1,w12) & iof(e12_2,k12_2,w12) & constitutedBy(e12_1,e12_2,w12)
% )).